# [13. Non-Referred Customers](https://takeuforward.org/practice/sql/non-referred-customers)
...
<p>You need to retrieve the names of customers who were **NOT** referred by customer **id = 2** . The output can be in any order.
