# [Big Countries](https://takeuforward.org/practice/sql/big-countries?source=sql---75-frequently-asked-interview-questions&category=querying-and-filtering&tab=problem)
...
</header>A global research organisation is analysing big countries based on either their land area or population size.&nbsp;
...
<section class="mt-6"><h3 class="ProblemPanel-module__qBixIa__sectionTitle">Example 1:</h3>
Example:
