...
| 0032 | [Reverse every word in a string](./DSA/Strings/reverse-every-word-in-a-string) | [String](./DSA/Strings/reverse-every-word-in-a-string/String.java) | 🟡 Medium | `DSA` / `Strings` |
