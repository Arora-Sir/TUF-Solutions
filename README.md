...
| 0008 | [Implement Queue using Arrays](./DSA/Stack-Queue/implement-queue-using-arrays) | [CPP](./DSA/Stack-Queue/implement-queue-using-arrays/CPP.java) [Java](./DSA/Stack-Queue/implement-queue-using-arrays/Java.java) [Solution-2](./DSA/Stack-Queue/implement-queue-using-arrays/Solution-2.java) [JAVA](./DSA/Stack-Queue/implement-queue-using-arrays/solution.java) | 🟢 Easy | `DSA` / `Stack-Queue` |
...
| 0010 | [Implement Stack using Queue](./DSA/Stack-Queue/implement-stack-using-queue) | [Solution-2](./DSA/Stack-Queue/implement-stack-using-queue/Solution-2.cpp) [Solution-2](./DSA/Stack-Queue/implement-stack-using-queue/Solution-2.java) [CPP](./DSA/Stack-Queue/implement-stack-using-queue/solution.cpp) [Java2](./DSA/Stack-Queue/implement-stack-using-queue/Java2.java) | 🟢 Easy | `DSA` / `Stack-Queue` |
